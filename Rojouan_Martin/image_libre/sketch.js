...
function preload() {
    img = loadImage("sun.jpeg", function () { //permet de venir importer une image apres importation dans le folder
...
function setup() {
    ...
    menu.addRange("seuil", 0, 255, params.treshold, 0.1, function (v) {
        params.treshold = v
    })
